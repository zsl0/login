...
public class StationInfoVO {
    ...
    // 结束经度
    private java.math.BigDecimal endStationLon;
    // 结束纬度
    private java.math.BigDecimal endStationLat;
    // 省份
    ...
    public BigDecimal getEndStationLon() {
        return endStationLon;
    }

    public void setEndStationLon(BigDecimal endStationLon) {
        this.endStationLon = endStationLon;
    }

    public BigDecimal getEndStationLat() {
        return endStationLat;
    }

    public void setEndStationLat(BigDecimal endStationLat) {
    ...
    public String toString() {
        return "StationInfoVO{" +
                ...
                ", endStationLon=" + endStationLon +
                ", endStationLat=" + endStationLat +
